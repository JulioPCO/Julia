...
#Function ODE
function F(x0_1,x0_2,x0_3,u,j,d)
x0 = [x0_1,x0_2,x0_3]
...
tspan = (dh*d-dh,dh*d) #integrating over the interval dh
...
JuMP.register(m, :F, 6, F, autodiff=true)
...
# system dynamics
eq[l=1:nx + 1,i=2:nfe + 1], x[l,i] - F(s[1,i - 1],s[2,i - 1],s[3,i - 1],u[i - 1],l, i-1.0) == 0

# continuity constraints
cont[l=1:nx + 1,i=2:nfe + 1], s[l,i] - x[l,i] == 0
cont0[l=1:nx + 1], s[l,1] - x0[l] == 0
